...
class _$DepartmentsModelImpl implements _DepartmentsModel {
  const _$DepartmentsModelImpl(
      {this.id, required this.name, required this.location});
  ...
  @override
  String toString() {
    return 'DepartmentsModel(id: $id, name: $name, location: $location)';
  }
...
abstract class _DepartmentsModel implements DepartmentsModel {
  const factory _DepartmentsModel(
      ...
      required final String location}) = _$DepartmentsModelImpl;
